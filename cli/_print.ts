/**
 * _print.ts — shared structured-output helpers for every CLI command.
 */
import type { ApcResponse } from '../src/apc.js';
...
/** Print a flat key→value summary (for the most useful fields). */
